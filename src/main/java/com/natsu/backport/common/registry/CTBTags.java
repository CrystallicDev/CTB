...
public class CTBTags {
	...
	public static class Blocks {
		public static final TagKey<Block> ARMADILLO_SPAWNABLE_ON = TagKey.create(Registry.BLOCK_REGISTRY, new ResourceLocation(CTBackport.MODID, "armadillo_spawnable_on"));
	...
	public static class Items {
		...
		public static final TagKey<net.minecraft.world.item.Item> ARMADILLO_FOOD =
				TagKey.create(Registry.ITEM_REGISTRY, new ResourceLocation(CTBackport.MODID, "armadillo_food"));
