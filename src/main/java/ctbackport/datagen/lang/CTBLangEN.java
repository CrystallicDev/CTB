...
public class CTBLangEN extends LanguageProvider implements DataGenBlockItemHandler {
	...
	protected void addTranslations() {
		...
		add("item.ctbackport.flow_banner_pattern", "Banner Pattern");
		add("item.ctbackport.flow_banner_pattern.desc", "Flow");
		add("item.ctbackport.guster_banner_pattern", "Banner Pattern");
		add("item.ctbackport.guster_banner_pattern.desc", "Guster");
		add("block.minecraft.banner.flow.white", "White Flow");
		add("block.minecraft.banner.guster.white", "White Guster");
		add("block.ctbackport.pink_petals", "Pink Petals");
		add("entity.ctbackport.armadillo", "Armadillo");
		add("item.ctbackport.armadillo_scute", "Armadillo Scute");
		add("item.ctbackport.wolf_armor", "Wolf Armor");
		...
		add("item.ctbackport.angler_pottery_sherd", "Angler Pottery Sherd");
		add("item.ctbackport.archer_pottery_sherd", "Archer Pottery Sherd");
		add("item.ctbackport.arms_up_pottery_sherd", "Arms Up Pottery Sherd");
		add("item.ctbackport.blade_pottery_sherd", "Blade Pottery Sherd");
		add("item.ctbackport.brewer_pottery_sherd", "Brewer Pottery Sherd");
		add("item.ctbackport.burn_pottery_sherd", "Burn Pottery Sherd");
		add("item.ctbackport.danger_pottery_sherd", "Danger Pottery Sherd");
		add("item.ctbackport.explorer_pottery_sherd", "Explorer Pottery Sherd");
		add("item.ctbackport.friend_pottery_sherd", "Friend Pottery Sherd");
		add("item.ctbackport.heart_pottery_sherd", "Heart Pottery Sherd");
		add("item.ctbackport.heartbreak_pottery_sherd", "Heartbreak Pottery Sherd");
		add("item.ctbackport.howl_pottery_sherd", "Howl Pottery Sherd");
		add("item.ctbackport.miner_pottery_sherd", "Miner Pottery Sherd");
		add("item.ctbackport.mourner_pottery_sherd", "Mourner Pottery Sherd");
		add("item.ctbackport.plenty_pottery_sherd", "Plenty Pottery Sherd");
		add("item.ctbackport.prize_pottery_sherd", "Prize Pottery Sherd");
		add("item.ctbackport.sheaf_pottery_sherd", "Sheaf Pottery Sherd");
		add("item.ctbackport.shelter_pottery_sherd", "Shelter Pottery Sherd");
		add("item.ctbackport.skull_pottery_sherd", "Skull Pottery Sherd");
		add("item.ctbackport.snort_pottery_sherd", "Snort Pottery Sherd");
