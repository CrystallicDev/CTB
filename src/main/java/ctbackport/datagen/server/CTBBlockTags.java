...
public class CTBBlockTags extends BlockTagsProvider {
    ...
    protected void addTags() {
		...
		tag(BlockTags.MINEABLE_WITH_PICKAXE).add(CTBBlocks.SULFUR.get());
		tag(BlockTags.MINEABLE_WITH_PICKAXE).add(CTBBlocks.SULFUR_STAIRS.get());
		tag(BlockTags.MINEABLE_WITH_PICKAXE).add(CTBBlocks.SULFUR_SLAB.get());
		tag(BlockTags.MINEABLE_WITH_PICKAXE).add(CTBBlocks.SULFUR_WALL.get());
		tag(BlockTags.MINEABLE_WITH_PICKAXE).add(CTBBlocks.POLISHED_SULFUR.get());
		tag(BlockTags.MINEABLE_WITH_PICKAXE).add(CTBBlocks.POLISHED_SULFUR_STAIRS.get());
		tag(BlockTags.MINEABLE_WITH_PICKAXE).add(CTBBlocks.POLISHED_SULFUR_SLAB.get());
		tag(BlockTags.MINEABLE_WITH_PICKAXE).add(CTBBlocks.POLISHED_SULFUR_WALL.get());
		tag(BlockTags.MINEABLE_WITH_PICKAXE).add(CTBBlocks.SULFUR_BRICKS.get());
		tag(BlockTags.MINEABLE_WITH_PICKAXE).add(CTBBlocks.SULFUR_BRICK_STAIRS.get());
		tag(BlockTags.MINEABLE_WITH_PICKAXE).add(CTBBlocks.SULFUR_BRICK_SLAB.get());
		tag(BlockTags.MINEABLE_WITH_PICKAXE).add(CTBBlocks.SULFUR_BRICK_WALL.get());
		tag(BlockTags.MINEABLE_WITH_PICKAXE).add(CTBBlocks.CHISELED_SULFUR.get());
		tag(BlockTags.MINEABLE_WITH_PICKAXE).add(CTBBlocks.CINNABAR.get());
		tag(BlockTags.MINEABLE_WITH_PICKAXE).add(CTBBlocks.CINNABAR_STAIRS.get());
		tag(BlockTags.MINEABLE_WITH_PICKAXE).add(CTBBlocks.CINNABAR_SLAB.get());
		tag(BlockTags.MINEABLE_WITH_PICKAXE).add(CTBBlocks.CINNABAR_WALL.get());
		tag(BlockTags.MINEABLE_WITH_PICKAXE).add(CTBBlocks.POLISHED_CINNABAR.get());
		tag(BlockTags.MINEABLE_WITH_PICKAXE).add(CTBBlocks.POLISHED_CINNABAR_STAIRS.get());
		tag(BlockTags.MINEABLE_WITH_PICKAXE).add(CTBBlocks.POLISHED_CINNABAR_SLAB.get());
		tag(BlockTags.MINEABLE_WITH_PICKAXE).add(CTBBlocks.POLISHED_CINNABAR_WALL.get());
		tag(BlockTags.MINEABLE_WITH_PICKAXE).add(CTBBlocks.CINNABAR_BRICKS.get());
		tag(BlockTags.MINEABLE_WITH_PICKAXE).add(CTBBlocks.CINNABAR_BRICK_STAIRS.get());
		tag(BlockTags.MINEABLE_WITH_PICKAXE).add(CTBBlocks.CINNABAR_BRICK_SLAB.get());
		tag(BlockTags.MINEABLE_WITH_PICKAXE).add(CTBBlocks.CINNABAR_BRICK_WALL.get());
